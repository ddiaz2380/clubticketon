...
class Admin extends My_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('layout/dashboard/header', array('title' => 'Panel de Administracion'));
    ...
    public function view_users()
    {
        ...
        $this->load->view('layout/dashboard/header', array('title' => 'Ver Usuarios'));
    ...
    public function view_product()
    {
        ...
        $this->load->view('layout/dashboard/header', array("title" => "Ver Productos"));
    ...
    public function add_product()
    {
        $this->gate_model->admin_gate();
        $data["categories"] = $this->category_model->getAllCategoriesWithSubCategories();
        $this->load->view('layout/dashboard/header', array("title" => "Agregar Productos"));
    ...
    public function edit_product($product_id)
    {
        ...
        $this->load->view('layout/dashboard/header', array("title" => "Editar Productos"));
        $this->loadSidebar("show_product", "manage_product_active");
    ...
    public function view_category()
    {
        ...
        $this->load->view('layout/dashboard/header', array("title" => "Ver Categorias"));
    ...
    public function manage_category($category_id)
    {
        ...
        $data["categories"] = $this->category_model->getAllCategoriesWithSubCategories();
        $this->load->view('layout/dashboard/header', array("title" => "Administrar Categorias"));
        $this->loadSidebar("show_category", "manage_category_active");
    ...
    public function add_category()
    {
        ...
        $data["parent_categories"] = $this->category_model->getAllParentCategories()->result();
        $data["categories"] = $this->category_model->getAllCategoriesWithSubCategories();
        $this->load->view('layout/dashboard/header', array("title" => "Agregar Categorias"));
    ...
    public function manage_order()
    {
        ...
        $data["orders"] = $orders;
        $this->load->view('layout/dashboard/header', array("title" => "Administrar Ordenes"));
    ...
    public function manage_cart()
    {
        ...
        $data["carts"] = $carts;
        $this->load->view('layout/dashboard/header', array("title" => "Administrar Carrito"));
    ...
    public function view_cart($cart_id)
    {
        ...
        $this->load->view('layout/dashboard/header', array("title" => "Ver Carrito"));
        $this->loadSidebar("show_order", "manage_cart_active");

...
<table class='table table-bordered' style='width:70%;' align='center'>
	...
	<tr>
	 ...
	 <td>
	  ...
	  <label for="municipio_nam" class="col-sm-3 control-label"> Municipio_name </label>

	 </td>

	 <td> 

	   <?php echo set_value("municipio_name",  html_entity_decode($municipio_table->municipio_name)); ?>

  ...
  <div class="wrapper wrapper-content animated fadeInRight">
	...
	<div class="form-group">
      ...
      foreach($user_table as $key => $value): ?>
          ...
          <option value="<?php echo $value->user_id; ?>" <?php echo $value->user_id==$user_comprobante_table->user_id?'selected="selected"':""; ?>>
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control datetimepicker" name="com_fecha_subida" id="com_fecha_subida" value="<?php echo set_value("com_fecha_subida",$user_comprobante_table->com_fecha_subida); ?>"/> 
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control datetimepicker" name="com_fecha_compra" id="com_fecha_compra" value="<?php echo set_value("com_fecha_compra",$user_comprobante_table->com_fecha_compra); ?>"/> 
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("com_numero",html_entity_decode($user_comprobante_table->com_numero)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("com_cuit",html_entity_decode($user_comprobante_table->com_cuit)); ?>"
...
<!-- Com_cuit End -->
	...
	<div class="form-group">
      ...
      foreach($municipio_table as $key => $value): ?>
          ...
          <option value="<?php echo $value->municipio_id; ?>" <?php echo $value->municipio_id==$user_comprobante_table->municipio_id?'selected="selected"':""; ?>>
    ...
    <div class="form-group">
      ...
      <input type="hidden" name="old_image_link" 

      value="<?php if (isset($image_link) && $image_link!=""){echo $image_link; }?>" />  
  ...
  <img src="<?php echo $this->config->item("photo_url");?><?php echo $user_comprobante_table->image_link; ?>" alt="pic" width="50" height="50" />
	...
	<div class="form-group">
      ...
      foreach($user_comprobante_estado_table as $key => $value): ?>
          ...
          <option value="<?php echo $value->user_com_es_id; ?>" <?php echo $value->user_com_es_id==$user_comprobante_table->com_estado_id?'selected="selected"':""; ?>>
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control datetimepicker" name="com_estado_date" id="com_estado_date" value="<?php echo set_value("com_estado_date",$user_comprobante_table->com_estado_date); ?>"/> 
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    <textarea class="form-control" id="com_estado_obs" name="com_estado_obs"><?php echo set_value("com_estado_obs",html_entity_decode($user_comprobante_table->com_estado_obs)); ?></textarea>
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("com_estado_opeid",html_entity_decode($user_comprobante_table->com_estado_opeid)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("product_cart_id",html_entity_decode($user_comprobante_table->product_cart_id)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("cart_id",html_entity_decode($user_comprobante_table->cart_id)); ?>"

	...
	<div class="modal fade" id="alert_modal">
		...
		<footer class="py-5 mt-5 bg-dark">
			<div class="container">
				<p class="m-0 text-center text-white">Copyright &copy; Club Ticketon 2022</p>
			</div>
			<!-- /.container -->
		</footer>
		...
		<script type="text/javascript">
			...
			function selectCategory(categoryID, categoryName) {
				$.get("<?= site_url('Product/selectProductCategory')?>", { 'categoryID' : categoryID }, function(data){
					...
					console.log(data);
					var string = "<h4>Resultados por categoria \""+categoryName+"\"...</h4>";
						...
						string += "<div class='col-lg-4 col-md-6 mb-4'>"
							+ "<div class='card h-100'>"
								+ "<a href='<?= base_url(); ?>index.php/Shop/product/"+data[i]['product_id']+"'>"
									...
									+ "<input type='number' name='quantity' class='form-control' placeholder='Cantidad' id='quantity_"+data[i]['product_id']+"' />"

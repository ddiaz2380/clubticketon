				...
				<div class="collapse navbar-collapse" id="navbarResponsive">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item <?= $about; ?>">
							<a class="nav-link" href="<?= site_url('shop/about');?>"><b>Acerce de</b></a>
						</li>
						<!-- <li class="nav-item">
							<a class="nav-link" href="#">Services</a>
						</li> -->
						<li class="nav-item <?= $contact; ?>">
							<a class="nav-link" href="<?= site_url('shop/contact');?>"><b>Contactenos</b></a>
						</li>
						<li class="nav-item">
							...
							<?php elseif ($this->session->userdata('usertype') == "user") : ?>
								...
								<li class="nav-item"><a class="nav-link" style="margin-left:5px" data-toggle="modal" data-target="#logout"><button class="btn btn-danger py-1">Log Out</button></a></li>
							<?php else : ?>
								<a class="nav-link" href="<?php echo base_url()?>index.php/Account"><button class="btn btn-success py-1">Iniciar sesión</button></a>
							<?php endif; ?>
						</li>
					</ul>
				</div>

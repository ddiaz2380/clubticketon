      ...
      <div class="card-body">
        <?=form_open(site_url('user/change_userdetail'));?>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
            <label for="email">Puntos</label>
            <input class="form-control" id="puntos" name="puntos" type="text" aria-describedby="emailHelp" placeholder="Puntos" value="<?= $userData->puntos; ?>" readonly>
          </div>          
          <button class="btn btn-primary btn-block" type="submit" >Update</button>
        <?=form_close();?>


        <!-- / add detail user_comprobantes -->

				...
				<div class="col-lg-8">
					<div class="card mt-4">
						<div class="card-body">
							...
							<!--<button class="pull-right btn btn-block btn-primary" type="button" onclick="addToCart(<?= $product->product_id; ?>,<?= $this->session->userdata('userid'); ?> )"> -->

							<button class="pull-right btn btn-block btn-primary" type="button" onclick="addToCart(<?= $product->product_id; ?>,<?= $this->session->userdata('userid'); ?>,<? echo $puntos; ?> ,<?= $product->product_price; ?>)">							

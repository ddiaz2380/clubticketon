		...
		<div class="col-lg-9">
			<div id="search-bar" class=" mt-4 mb-2">
				<div class="input-group">
					<input type="text" name="search" id="search" class="form-control" placeholder="Buscar Productos..."/>
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							...
							<?php 
								...
								//echo "user:".$user_id;
								//$puntos = $this->session->userdata('puntos');
								//$userdetail=$this->user_model->get_userdetail();
								//$userdetail=get_userdetail();
								//$puntos=$userdetail['puntos'];
								if (isset($user_id)) {
									//$puntos = $this->session->userdata('puntos');
									//echo "puntos:".$puntos;								
									
									$query = $this->db->query("select puntos from user_table where user_id = ". $user_id);
									$puntos=0;
							...
							?>
								<div class="card-footer">
									...
									<input type="number" name="quantity" class="form-control" placeholder="Cantidad" id="quantity_<?= $product->product_id; ?>" />
									...
									<button class="pull-right btn btn-block btn-primary" type="button" onclick="addToCart(<?= $product->product_id; ?>,<?php echo $user_id; ?>,<?php echo $puntos; ?> ,<?php echo $precio; ?>)">
